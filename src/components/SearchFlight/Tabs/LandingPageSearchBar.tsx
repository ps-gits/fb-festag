...
const LandingPageSearchBar = (props: tabType) => {
  ...
  return (
    <div className="relative">
      <div>
        <div className="xl:flex md:flex xl:py-0 xs:py-3  xs:block  xl:m-auto gap-2 relative items-center px-4   ">
            ...
            <div>
              ...
              <div className="xl:not-sr-only	xs:sr-only">
                <div className="flex gap-3 items-center  ">
                  <div className="xl:w-1/3 xs:w-full xl:mb-0 xs:mb-2">
                    <p className="text-xs text-red">{errorMessage?.departure}</p>
                  </div>
                  <div className="xl:w-1/3 xs:w-full xl:mb-0 xs:mb-2">
                    <p className="text-xs text-red">
              ...
              <div className="xl:flex md:flex xs:block w-full gap-2 pt-2">
                <div className="xl:w-1/3 md:w-full xs:full rounded border bg-white border-cadetgray">
                  <div className="flex items-center xl:py-2 xs:py-2">
                    <button
                      className="relative  px-2 font-semibold  border-0 w-full block text-black  text-sm  text-left "
                      type="button"
                ...
                <div className="xl:w-1/3 xs:w-full xl:mb-0 xs:mb-2 md:mb-0">
                  <div className="w-full rounded border  bg-white  border-cadetgray xl:mt-0 xs:mt-2 md:mt-0">
                    <div className="flex items-center  xl:py-2 xs:py-2">
                      <button
                      ...
                      >
                        ...
                        <div>
                          <p className="text-slategray font-normal text-sm">{getDate('return')}</p>
                          <div className="absolute right-1 top-4 text-slategray text-sm">
                            <FontAwesomeIcon icon={faAngleDown} aria-hidden="true" />
                          </div>
                        </div>
                      </button>
                ...
                <div className="xl:w-1/3 xs:w-full xl:mt-0 xs:mt-2 md:mt-0 rounded border bg-white  border-cadetgray">
                  <div className="flex items-center xl:py-2 xs:py-2">
                    <button
                      className="relative  px-2   font-semibold  border-0 w-full block text-black  text-sm  text-left"
                      type="button"
